...
import static com.example.finalyearapp.Maps.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;
...
public class Locationservices extends AppCompatActivity {
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(Locationservices.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(Locationservices.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
